...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container">
            <p>Search</p>
            <form name="fo" method="get" action="" style="width: 100%; text-align:center; margin: auto;" class="justify-content-center" >
                <p>
                    <input type="text" name="keywords" pattern=".{3,}"   oninvalid="this.setCustomValidity('Field must contain min. 3 characters')" value="<?php echo $keywords?>" placeholder="What are you searching for ?" style="width: 100%; height: 40px; color:darkgrey; text-align:center;"/><br>
                    <input type="submit" name="submit" class="btn btn-primary btn-lg btn-block mt-3" />
                </p>
                <p> 
                
                    
                    <input type="radio" class="btn-check" name="type" value="movie" id="movie" autocomplete="off" required checked>
                    <label class="btn btn-secondary" for="movie">Movie</label>

                    <input type="radio" class="btn-check" name="type" value="serie" id="serie" autocomplete="off">
